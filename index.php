    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">Best hotel around the world</h1>
                <p class="animated fadeInUp">Most luxurious hotel around the world with the royal treatments and excellent customer service.</p>                
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Rooms<a href="rooms.php" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
